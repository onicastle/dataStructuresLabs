...
public class LinkedBinaryTree<E> extends AbstractBinaryTree<E> implements Cloneable{
	...
	public LinkedBinaryTree<E> clone() throws CloneNotSupportedException {
		...
		if (!isEmpty()) {
			...
			throw new CloneNotSupportedException("Tree is empty");
		}
		subtreeCloner(root(),other,other.root);

		return other;
	}

	private void subtreeCloner(Position<E> rThis, LinkedBinaryTree<E> other, Position<E> rOther) {
		if(rOther != null){
